...
CREATE TABLE `appointment` (
  `id` int(11) NOT NULL,
  `workerSpecialization` varchar(255) DEFAULT NULL,
  ...
  `workerStatus` int(11) DEFAULT NULL,
...
INSERT INTO `appointment` (`id`, `workerSpecialization`, `workerId`, `userId`, `consultancyFees`, `appointmentDate`, `appointmentTime`, `postingDate`, `userStatus`, `workerStatus`, `updationDate`) VALUES
...
INSERT INTO `workers` (`id`, `specilization`, `workerName`, `address`, `docFees`, `contactno`, `docEmail`, `password`, `creationDate`, `updationDate`) VALUES
...
INSERT INTO `workerslog` (`id`, `uid`, `username`, `userip`, `loginTime`, `logout`, `status`) VALUES
...
--
-- Table structure for table `workerspecilization`
--

CREATE TABLE `workerspecilization` (
  `id` int(11) NOT NULL,
  `specilization` varchar(255) DEFAULT NULL,
  `creationDate` timestamp NULL DEFAULT current_timestamp(),
  `updationDate` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp()
...
--
-- Dumping data for table `workerspecilization`
--

INSERT INTO `workerspecilization` (`id`, `specilization`, `creationDate`, `updationDate`) VALUES
...
(2, 'Anuj kumar', 'ak@gmail.com', 1111122233, 'This is for testing', '2022-11-06 13:13:41', 'Contact the customer', '2022-11-06 13:13:57', 1);

-- --------------------------------------------------------

--
-- Table structure for table `tblcriminalhistory`
--

CREATE TABLE `tblcriminalhistory` (
  `ID` int(10) NOT NULL,
  ...
  `criminalPres` mediumtext DEFAULT NULL,
  `CreationDate` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tblcriminalhistory`
--

INSERT INTO `tblcriminalhistory` (`ID`, `customerID`, `BloodPressure`, `BloodSugar`, `Weight`, `Temperature`, `criminalPres`, `CreationDate`) VALUES
...
CREATE TABLE `tblcustomer` (
  ...
  `customerContno` bigint(10) DEFAULT NULL,
  `customerEmail` varchar(200) DEFAULT NULL,
  `customerGender` varchar(50) DEFAULT NULL,
  `customerAdd` mediumtext DEFAULT NULL,
  `customerAge` int(10) DEFAULT NULL,
  `customerMedhis` mediumtext DEFAULT NULL,
  `CreationDate` timestamp NULL DEFAULT current_timestamp(),
  `UpdationDate` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tblcustomer` (`ID`, `Docid`, `customerName`, `customerContno`, `customerEmail`, `customerGender`, `customerAdd`, `customerAge`, `customerMedhis`, `CreationDate`, `UpdationDate`) VALUES
...
--
-- Indexes for table `workerslog`
--
ALTER TABLE `workerslog`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `workerspecilization`
--
ALTER TABLE `workerspecilization`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tblcriminalhistory`
--
ALTER TABLE `tblcriminalhistory`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `workerslog`
--
ALTER TABLE `workerslog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `workerspecilization`
--
ALTER TABLE `workerspecilization`
...
--
-- AUTO_INCREMENT for table `tblcriminalhistory`
--
ALTER TABLE `tblcriminalhistory`
