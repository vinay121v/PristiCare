								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Manage Workers</h2>
										
											<p class="cl-effect-1">
												<a href="manage-worker.php">
												<?php $result1 = mysqli_query($con,"SELECT * FROM workers ");
$num_rows1 = mysqli_num_rows($result1);
{
?>
											Total Workers :<?php echo htmlentities($num_rows1);  } ?>		
												</a>
...
{
?>
											Total Services :<?php echo htmlentities($num_rows2);  } ?>	
												</a>
												</a>
											</p>
										</div>
...
<?php $result = mysqli_query($con,"SELECT * FROM tblcustomer ");
$num_rows = mysqli_num_rows($result);
{
?>
Total customers :<?php echo htmlentities($num_rows);  
} ?>		
</a>
											</p>
										</div>
