...
$email=$_POST['email'];
$query=mysqli_query($con,"select id from  workers where contactno='$contactno' and docEmail='$email'");
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.php"><h2> Pristicare | Service Provider Password Recovery</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							<legend>
							Service Provider Password Recovery
							</legend>
							<p>
