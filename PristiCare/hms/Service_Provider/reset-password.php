...
$query=mysqli_query($con,"update workers set password='$newpassword' where contactno='$cno' and docEmail='$email'");
if ($query) {
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2> Pristicare | Customers Reset Password</h2></a>
				</div>
